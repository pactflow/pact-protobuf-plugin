...
mod tests {
    ...
    async fn test_proto_client() {
        ...
        let mut client = user_service_client::UserServiceClient::connect(url.to_string())
            .await
            .unwrap();
        ...
        expect!(response_message.get_ref().id.as_str())
            .to(be_equal_to("89b9475a-09d0-47a9-a4bc-2b6b9d361db6"));
    }
}
